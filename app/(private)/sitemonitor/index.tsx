            ...
            <View className="flex-1 px-8">
                ...
                <View className='flex-1 justify-between'>
                    <View className="flex-row gap-2">
                        <Card.Root className="w-[158px] h-[132px]" onPress={() => router.push('/sitemonitor/create-ticket')} >
                            <Card.Content>
                        ...
                        <Card.Root className="w-[158px] h-[132px]" onPress={() => router.push('/sitemonitor/view-ticket')} >
                            <Card.Content>
