        ...
        <View className="flex-1 bg-background-secondary">
            ...
            <View className="flex-1 px-8">
                ...
                <View className='flex-1 justify-between'>
                    <View>
                        <Label required>Disposal Site</Label>
                        <DropdownMenu value={disposalSite} onValueChange={setDisposalSite}>
                            <DropdownMenuTrigger className="w-full" placeholder="Select Disposal Site" />
                            <DropdownMenuContent width={320}>
                                <DropdownMenuLabel>Select Disposal Site</DropdownMenuLabel>
                                <DropdownMenuCheckboxItem label="Site A" value="site_a" />
                                <DropdownMenuCheckboxItem label="Site B" value="site_b" />
                            </DropdownMenuContent>
                        </DropdownMenu>
                    </View>
                    <Button
